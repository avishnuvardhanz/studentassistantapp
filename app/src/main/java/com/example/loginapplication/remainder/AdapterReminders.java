...
public class
AdapterReminders extends RecyclerView.Adapter<com.example.loginapplication.remainder.AdapterReminders.MyViewHolder>{

    private List<com.example.loginapplication.remainder.Reminders> allReminders;
    private TextView message,time;

    public AdapterReminders(List<com.example.loginapplication.remainder.Reminders> allReminders) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        com.example.loginapplication.remainder.Reminders reminders = allReminders.get(i);
