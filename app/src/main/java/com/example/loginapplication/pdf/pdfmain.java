...
public class pdfmain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coursetell=findViewById(R.id.coursetell);

        String childpath=getIntent().getExtras().getString("Value");
coursetell.setText(childpath);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(pdfmain.this,"FILE UPLOADED",Toast.LENGTH_SHORT).show();
    ...
    public void btn_action(View view){
        ...
        String viewcoursedoc=coursetell.getText().toString();
        intent.putExtra("Value",viewcoursedoc);
